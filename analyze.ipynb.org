 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "import shap\n",
    "shap.initjs()\n",
    "explainer = shap.TreeExplainer(model=predicter_obj.estimator, feature_dependence='tree_path_dependent', model_output='margin')\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "for _, estimator in estimator_data['single_estimators']:\n",
