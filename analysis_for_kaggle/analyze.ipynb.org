 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "df_2d_train = visualizer_obj.plot_x_train_with_2_dimensions(\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "df_2d_train_test = visualizer_obj.plot_x_train_test_with_2_dimensions(\n",
    "    train_data['X_train'].toarray(), train_data['X_test'].toarray(),\n",
    "    train_data['train_ids'], train_data['test_ids'])\n",
  ...
  },
  {
   ...
   "source": [
    "logger.info('### PLOT X TRAIN WITH 2 DIMENSIONS')\n",
    "logger.info('### Y_train')\n",
    "df_2d_train_y_train = visualizer_obj.plot_x_train_with_2_dimensions(\n",
    "    train_data['X_train'].toarray(), train_data['Y_train'], train_data['train_ids'])\n",
    "logger.info('### Y_train_pred')\n",
    "df_2d_train_y_train_pred = visualizer_obj.plot_x_train_with_2_dimensions(\n",
