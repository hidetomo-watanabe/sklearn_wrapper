 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    data_for_view['train_df'], data_for_view['pred_df'])"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "shap_values = explainer.shap_values(X=data_for_model['X_train'].toarray(), y=data_for_model['Y_train'])\n",
    "shap.summary_plot(shap_values, data_for_model['X_train'].toarray(), feature_names=data_for_model['feature_columns'])\n",
