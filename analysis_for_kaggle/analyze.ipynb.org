 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    Visualizer.sample_like(raw_data['train_df'], frac=0.5),\n",
    "    Visualizer.sample_like(raw_data['test_df'], frac=0.5),\n",
    "    Visualizer.sample_like(raw_data['pred_df'], frac=0.5))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "visualizer_obj.plot_x_train_histogram(\n",
    "    Visualizer.sample_like(raw_data['train_df'], frac=0.5),\n",
    "    Visualizer.sample_like(raw_data['pred_df'], frac=0.5))"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "visualizer_obj.plot_scatter_matrix(\n",
    "    Visualizer.sample_like(train_data['X_test'].toarray(), frac=0.5),\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    Visualizer.sample_like(train_data['X_train'].toarray(), frac=0.5),\n",
    "    Visualizer.sample_like(train_data['Y_train'], frac=0.5),\n",
    "    train_data['feature_columns'])"
   ]
  },
  {
  ...
  },
  {
   ...
   "source": [
    ...
    "visualizer_obj.plot_x_train_with_2_dimensions(\n",
    "    Visualizer.sample_like(train_data['X_train'].toarray(), frac=0.5),\n",
    "    Visualizer.sample_like(train_data['Y_train'], frac=0.5))"
   ]
  },
  {
   ...
   "source": [
    ...
    "visualizer_obj.plot_x_train_test_with_2_dimensions(\n",
    "    Visualizer.sample_like(train_data['X_train'].toarray(), frac=0.5),\n",
    "    Visualizer.sample_like(train_data['X_test'].toarray(), frac=0.5))"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "visualizer_obj.plot_x_train_with_2_dimensions(\n",
    "    Visualizer.sample_like(train_data['X_train'].toarray(), frac=0.5),\n",
    "    Visualizer.sample_like(Y_train_pred.reshape(-1, 1), frac=0.5))"
   ]
  },
  {
   "cell_type": "code",
