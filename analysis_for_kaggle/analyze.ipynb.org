 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    Visualizer.sample_like(raw_data['train_df'], frac=1.0),\n",
    "    Visualizer.sample_like(raw_data['test_df'], frac=1.0),\n",
    "    Visualizer.sample_like(raw_data['pred_df'], frac=1.0))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "    train_data['X_train'].toarray(), train_data['X_test'].toarray())"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "visualizer_obj.plot_x_train_with_2_dimensions(\n",
    "    train_data['X_train'].toarray(), Y_train_pred.reshape(-1, 1))"
   ]
  },
  {
   "cell_type": "code",
