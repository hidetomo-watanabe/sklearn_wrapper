{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "logger.info('### PLOT TRAIN PRED HISTOGRAM')\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "logger.info('### PLOT TRAIN TEST HISTOGRAM')\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "logger.info(train_data['X_train'].shape)\n",
    "logger.info('### TEST SHAPE')\n",
    "logger.info(train_data['X_test'].shape)"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "logger.info('### VISUALIZE PARTIAL DEPENDENCE')\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "logger.info('### VISUALIZE Y TRAIN PRED DATA')\n",
