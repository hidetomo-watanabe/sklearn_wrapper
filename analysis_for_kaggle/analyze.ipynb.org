 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    data_for_view['train_df'].sample(frac=1), data_for_view['pred_df'].sample(frac=1))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "import pandas as pd\n",
    "pd.plotting.scatter_matrix(data_for_view['train_df'].sample(frac=1))"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "pandas_profiling.ProfileReport(data_for_view['train_df'].sample(frac=1))"
   ]
  },
  {
   "cell_type": "code",
