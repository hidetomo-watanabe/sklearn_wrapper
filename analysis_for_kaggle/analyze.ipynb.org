 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "    data_for_view['train_df'].sample(frac=1, replace=False, random_state=42),\n",
    "    data_for_view['pred_df'].sample(frac=1, replace=False, random_state=42))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "    data_for_model['X_train'].toarray(), data_for_model['Y_train'],\n",
    "    data_for_model['feature_columns'])"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "for feature in data_for_model['feature_columns']:\n",
