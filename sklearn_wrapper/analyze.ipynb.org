 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "visualizer_obj.display_dfs(train_data['train_df'], train_data['test_df'], train_data['pred_df'])"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "import pandas_profiling\n",
    "pandas_profiling.ProfileReport(Visualizer.sample_like(train_data['train_df'], frac=0.01))"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "import pandas_profiling\n",
    "pandas_profiling.ProfileReport(Visualizer.sample_like(train_data['test_df'], frac=0.01))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "        train_data['train_df'],\n",
    "        train_data['pred_df'][pred_col].to_numpy())"
   ]
  },
  {
   "cell_type": "code",
   ...
   "source": [
    ...
    "visualizer_obj.plot_df_histograms(\n",
    "    pd.concat([train_data['train_df'], train_data['test_df']]),\n",
    "    np.concatenate(\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "            estimator=estimator, X=train_data['X_train'].toarray(),\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        estimator, train_data['X_train'], train_data['Y_train'], train_data['feature_columns'])"
   ]
  },
  {
   "cell_type": "markdown",
